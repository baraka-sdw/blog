...
Unsafe是位于sun.misc包下的一个类，主要提供一些用于执行低级别、不安全操作的方法，如直接访问系统内存资源、自主管理内存资源等，这些方法在提升Java运行效率、增强Java语言底层资源操作能力方面起到了很大的作用。但由于Unsafe类使Java语言拥有了类似C语言指针一样操作内存空间的能力，这无疑也增加了程序发生相关指针问题的风险。在程序中过度、不正确使用Unsafe类会使得程序出错的概率变大，使得Java这种安全的语言变得不再“安全”，因此对Unsafe的使用一定要慎重。注：本文对sun.misc.Unsafe公共API功能及相关应用场景进行介绍。
<!-- more -->
...
```
那如若想使用这个类，该如何获取其实例？有如下两个可行方案。其一，从getUnsafe方法的使用限制条件出发，通过Java命令行命令-Xbootclasspath/a把调用Unsafe相关方法的类A所在jar包路径追加到默认的bootstrap路径中，使得A被引导类加载器加载，从而通过Unsafe.getUnsafe方法安全的获取Unsafe实例。
``` java
...
```
### 功能介绍
![image](https://user-gold-cdn.xitu.io/2019/6/12/16b4bc202a2eddcf?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
...
![image](https://user-gold-cdn.xitu.io/2019/6/12/16b4bc202a6920e5?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
...
![image](https://user-gold-cdn.xitu.io/2019/6/12/16b4bc202ac49d72?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
...
![images](https://user-gold-cdn.xitu.io/2019/6/12/16b4bc202e5057de?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
...
![images](https://user-gold-cdn.xitu.io/2019/6/12/16b4bc202f61f985?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
...
![images](https://user-gold-cdn.xitu.io/2019/6/12/16b4bc20cbb85fb0?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
...
![images](https://user-gold-cdn.xitu.io/2019/6/12/16b4bc20db879756?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
...
![images](https://user-gold-cdn.xitu.io/2019/6/12/16b4bc20dbeadad6?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
...
![images](https://user-gold-cdn.xitu.io/2019/6/12/16b4bc20dbc9ccab?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
...
![images](https://user-gold-cdn.xitu.io/2019/6/12/16b4bc20dfc0af18?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
...
![images](https://user-gold-cdn.xitu.io/2019/6/12/16b4bc20eb772606?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
...
![images](https://user-gold-cdn.xitu.io/2019/6/12/16b4bc210c76c2d5?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
...
作者：我是月亮呀
链接：https://juejin.im/post/5d0651edf265da1bd3055891
来源：掘金
